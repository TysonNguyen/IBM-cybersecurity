...
exports.BuildUtils = exports.LernaUtils = exports.ExtensionTarget = exports.PublishEndpoint = exports.SemverVersion = void 0;
...
(function (ExtensionTarget) {
    ExtensionTarget["DENDRON"] = "dendron";
    ExtensionTarget["NIGHTLY"] = "nightly";
})(ExtensionTarget = exports.ExtensionTarget || (exports.ExtensionTarget = {}));
...
class BuildUtils {
    ...
    static getNextServerRootPath() {
        return path_1.default.join(this.getLernaRoot(), "packages", "dendron-next-server");
    }
     ...
     * @returns
     */
    static async packagePluginDependencies({ skipSentry, quiet, }) {
    ...
    static async prepPluginPkg(target = ExtensionTarget.DENDRON) {
        const pkgPath = path_1.default.join(this.getPluginRootPath(), "package.json");
        let version;
        let description;
        let icon;
    ...
    static async syncStaticAssets() {
        ...
        // DEPRECATED
        fs_extra_1.default.copySync(path_1.default.join(nextServerRoot, "out"), pluginStaticPath);
        fs_extra_1.default.copySync(path_1.default.join(this.getNextServerRootPath(), "assets", "js"), path_1.default.join(pluginStaticPath, "js"));
    ...
    static async syncStaticAssetsToNextjsTemplate() {
        // all assets are stored here
        const commonAssetsBuildRoot = path_1.default.join(this.getLernaRoot(), "packages", "common-assets", "build");
        // destination for assets
        const templatePublicPath = path_1.default.join(this.getLernaRoot(), "packages", "nextjs-template", "public");
        ...
        fs_extra_1.default.copySync(path_1.default.join(commonAssetsBuildRoot, "assets"), templateAssetPath);
        fs_extra_1.default.copySync(path_1.default.join(commonAssetsBuildRoot, "top"), templatePublicPath);
    }
    ...
    static updatePkgMeta({ pkgPath, name, displayName, description, main, repository, version, icon, }) {
        const pkg = fs_extra_1.default.readJSONSync(pkgPath);
        pkg.name = name;
        if (description) {
