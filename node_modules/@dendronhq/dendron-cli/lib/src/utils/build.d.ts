...
export declare class BuildUtils {
    ...
    static getNextServerRootPath(): string;
     ...
     * @returns
     */
    static packagePluginDependencies({ skipSentry, quiet, }: {
        skipSentry?: boolean;
        quiet?: boolean;
    }): Promise<void>;
    static prepPluginPkg(target?: ExtensionTarget): Promise<void>;
    /**
    ...
    static installAndPackageDeps({ cwd }: {
        cwd: string;
    }): Promise<void>;
