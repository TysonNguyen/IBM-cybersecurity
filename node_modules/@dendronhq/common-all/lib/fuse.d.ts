...
import { DEngineMode, NoteProps, NotePropsByIdDict, SchemaModuleDict, SchemaModuleProps, SchemaProps } from ".";
...
export declare class FuseEngine {
    ...
    updateNotesIndex(notes: NotePropsByIdDict): Promise<void>;
