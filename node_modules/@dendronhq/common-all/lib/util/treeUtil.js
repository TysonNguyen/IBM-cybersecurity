...
class TreeUtils {
    ...
    static note2Tree({ noteId, noteDict, }) {
        ...
        return {
            ...
            navExclude: (_a = note.custom) === null || _a === void 0 ? void 0 : _a.nav_exclude,
            children: this.sortNotesAtLevel({
                noteIds: note.children,
                noteDict,
                reverse: ((_b = note.custom) === null || _b === void 0 ? void 0 : _b.sort_order) === "reverse",
            })
...
TreeUtils.sortNotesAtLevel = ({ noteIds, noteDict, reverse, labelType, }) => {
    var _a;
    const out = lodash_1.default.sortBy(noteIds, 
