...
import { DEngineClient, DLink, DNodeOpts, DNodeProps, DNodePropsDict, DNodePropsQuickInputV2, DNoteLoc, DVault, NoteChangeEntry, NoteLocalConfig, NoteOpts, NoteProps, NotePropsDict, SchemaModuleDict, SchemaModuleOpts, SchemaModuleProps, SchemaOpts, SchemaProps, SchemaPropsDict, SchemaRaw } from "./types";
import { NoteFNamesDict } from "./utils";
/**
...
export declare class DNodeUtils {
    ...
    static findClosestParent(fpath: string, nodes: NotePropsDict, notesByFnameDict: NoteFNamesDict, opts: {
        noStubs?: boolean;
        vault: DVault;
        wsRoot: string;
    }): DNodeProps;
    ...
    static cleanFname(fname: string): string;
}
export declare class NoteUtils {
     ...
     */
    static getNoteLocalConfig(note: NoteProps): Partial<{
        global: Partial<Pick<import("./types").DendronGlobalConfig, "enablePrettyRefs" | "enableBackLinks" | "enableChildLinks">>;
    }>;
     ...
     */
    static updateNoteMetadata({ note, fmChangeOnly, engine, enableLinkCandidates, }: {
        note: NoteProps;
    ...
    static validate(noteProps: Partial<NoteProps>): true | DendronError<import("http-status-codes/build/cjs/status-codes").StatusCodes | undefined>;
    ...
    static isFakeId(id: string): boolean;
