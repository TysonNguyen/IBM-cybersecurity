...
import { DendronGraphConfig } from "../workspace/graph";
...
export declare type DendronWorkspace = {
    name: string;
    vaults: DVault[];
    remote: RemoteEndpoint;
};
export declare type DendronWorkspaceEntry = Omit<DendronWorkspace, "name" | "vaults">;
