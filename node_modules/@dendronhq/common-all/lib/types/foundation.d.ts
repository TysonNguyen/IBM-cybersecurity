...
export declare type NoteLocalConfig = Partial<{
    global: Partial<Pick<DendronGlobalConfig, "enableChildLinks" | "enablePrettyRefs" | "enableBackLinks">>;
}>;
 ...
 */
export declare type NotePropsMeta = Omit<NoteProps, "body" | "contentHash">;
/**
