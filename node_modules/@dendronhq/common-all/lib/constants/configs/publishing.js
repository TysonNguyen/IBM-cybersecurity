...
const github_1 = require("../../types/configs/publishing/github");
const global_1 = require("./global");
const GITHUB_EDIT_VIEW_MODE = {
    [github_1.GithubEditViewModeEnum.edit]: {
        value: github_1.GithubEditViewModeEnum.edit,
        label: "Edit",
        desc: "Links directly to edit mode.",
    },
    [github_1.GithubEditViewModeEnum.tree]: {
        value: github_1.GithubEditViewModeEnum.tree,
        label: "Tree",
...
exports.PUBLISHING = {
    enableFMTitle: (0, global_1.ENABLE_FM_TITLE)("publishing"),
    ...
    enableNoteTitleForLink: (0, global_1.ENABLE_NOTE_TITLE_FOR_LINK)("publishing"),
    enableMermaid: (0, global_1.ENABLE_MERMAID)("publishing"),
    enablePrettyRefs: (0, global_1.ENABLE_PRETTY_REFS)("publishing"),
    enableKatex: (0, global_1.ENABLE_KATEX)("publishing"),
    assetsPrefix: {
        label: "Assets Prefix",
    ...
    enableBackLinks: (0, global_1.ENABLE_BACK_LINKS)("publishing"),
    enableFrontmatterTags: (0, global_1.ENABLE_FRONTMATTER_TAGS)("publishing"),
    enableHashesForFMTags: (0, global_1.ENABLE_HASHES_FOR_FM_TAGS)("publishing"),
