...
import { DendronSiteConfig, DHookDict, DVault, LegacyDuplicateNoteBehavior, LegacyHierarchyConfig, NoteChangeEntry, NoteProps } from "../types";
...
export declare class ConfigUtils {
     ...
     */
    static genLatestConfig(defaults?: DeepPartial<StrictConfigV5>): StrictConfigV5;
    ...
    static getHierarchyDisplayConfigForPublishing(config: IntermediateDendronConfig): {
