...
class ConfigUtils {
    ...
    static genLatestConfig(defaults) {
        ...
        return lodash_1.default.merge({
            ...
            ...common,
            commands: (0, intermediateConfigs_1.genDefaultCommandConfig)(),
            workspace: { ...(0, intermediateConfigs_1.genDefaultWorkspaceConfig)(), enableSmartRefs: true },
            preview: (0, intermediateConfigs_1.genDefaultPreviewConfig)(),
            publishing: (0, publishing_1.genDefaultPublishingConfig)(),
        }, defaults);
    }
    ...
    static getHierarchyDisplayConfigForPublishing(config) {
        const isConfigV4 = (0, intermediateConfigs_1.configIsV4)(config);
...
function normalizeUnixPath(fsPath) {
    return path_1.default.posix.normalize(fsPath.replace(/\\/g, "/"));
}
