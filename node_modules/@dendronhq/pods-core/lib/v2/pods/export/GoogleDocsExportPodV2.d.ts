...
export declare class GoogleDocsExportPodV2 implements ExportPodV2<GoogleDocsExportReturnType> {
    ...
    overwriteGdoc(opts: {
        ...
        data: GoogleDocsFields[];
        errors: IDendronError<import("@dendronhq/common-all").StatusCodes | undefined>[];
    }>;
    /**
...
export declare class GoogleDocsUtils {
    static updateNotesWithCustomFrontmatter(records: GoogleDocsFields[], engine: DEngineClient): Promise<void>;
}
export {};
