import { DEngineClient, IntermediateDendronConfig, NoteProps, RespV2 } from "@dendronhq/common-all";
...
export declare class MarkdownExportPodV2 implements ExportPodV2<MarkdownExportReturnType> {
    ...
    exportNotes(input: NoteProps[]): Promise<MarkdownExportReturnType>;
    renderNote(input: NoteProps): string;
