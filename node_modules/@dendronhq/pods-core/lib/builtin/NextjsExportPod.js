...
function getSiteConfig({ config, overrides, }) {
    if ((0, common_all_1.configIsV4)(config)) {
        const siteConfig = common_all_1.ConfigUtils.getSite(config);
        return {
            ...siteConfig,
            ...overrides,
            usePrettyLinks: true,
...
class NextjsExportPod extends basev3_1.ExportPod {
    ...
    async plant(opts) {
        ...
        const engineConfig = common_all_1.ConfigUtils.overridePublishingConfig(engine.config, siteConfig);
        ...
        const tree = common_all_1.TreeUtils.generateTreeData(payload.notes, payload.domains);
