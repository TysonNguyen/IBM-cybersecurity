import { IntermediateDendronConfig, DendronSiteConfig, DEngineClient, NoteProps, NotePropsByIdDict } from "@dendronhq/common-all";
...
export declare type BuildOverrides = Pick<DendronSiteConfig, "siteUrl">;
...
export declare class NextjsExportPod extends ExportPod<NextjsExportConfig> {
    ...
    _renderNote({ engine, note, notes, engineConfig, }: {
    ...
    renderBodyToHTML({ engine, note, notesDir, notes, engineConfig, }: Parameters<NextjsExportPod["_renderNote"]>[0] & {
        notesDir: string;
        engineConfig: IntermediateDendronConfig;
    }): Promise<void>;
