import { DEngineClient, DNoteRefLink, getSlugger, NoteProps, NotePropsDict, NotesCacheEntry, RespV3 } from "@dendronhq/common-all";
...
export declare class EngineUtils {
     ...
     * @returns
     */
    static refreshNoteLinksAndAnchors({ note, engine, }: {
        note: NoteProps;
