...
class DConfig {
    ...
    static getOrCreate(dendronRoot, defaults) {
        ...
        if (!fs_extra_1.default.existsSync(configPath)) {
            ...
            config = {
                ...config,
                ...(0, common_server_1.readYAML)(configPath),
            };
        }
        return config;
    }
    ...
    static cleanSiteConfig(config) {
        const out = lodash_1.default.defaults(config, {
            copyAssets: true,
            usePrettyRefs: true,
            siteNotesDir: "notes",
    ...
    static setCleanPublishingConfig(opts) {
        ...
        const key = (0, common_all_1.configIsV4)(config) ? "site" : "publishing";
        common_all_1.ConfigUtils.setProp(config, key, cleanConfig);
    }
    /**
    ...
    static searchLocalConfigSync(wsRoot) {
        ...
        if (foundPath) {
            ...
            const data = (0, common_server_1.readYAML)(foundPath);
            return { data };
        }
        return {
     ...
     * @returns
     */
    static readConfigAndApplyLocalOverrideSync(wsRoot) {
    ...
    static writeConfig({ wsRoot, config, }) {
        const configPath = DConfig.configPath(wsRoot);
        return (0, common_server_1.writeYAMLAsync)(configPath, config);
    }
