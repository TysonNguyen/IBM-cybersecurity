...
class WorkspaceService {
    ...
    get config() {
        ...
        return config_1.DConfig.readConfigAndApplyLocalOverrideSync(this.wsRoot);
    }
    get seedService() {
    ...
    async createSelfContainedVault(opts) {
        ...
        config_1.DConfig.getOrCreate(vaultPath, {
            dev: {
    ...
    async removeVault(opts) {
        ...
        if (publishingConfig.duplicateNoteBehavior &&
            ...
            if (vaults.length === 1) {
                ...
                const updatedDuplicateNoteBehavior = publishingConfig.duplicateNoteBehavior;
                lodash_1.default.pull(updatedDuplicateNoteBehavior.payload, vault.fsPath);
                common_all_1.ConfigUtils.setDuplicateNoteBehavior(config, updatedDuplicateNoteBehavior);
            }
        }
        if (updateConfig) {
    ...
    static async createSelfContainedVaultWorkspace(opts) {
        ...
        if (vaults && vaults.length > 0) {
            ...
            const selfContainedVaults = vaults.map(WorkspaceService.standardToSelfContainedVault);
