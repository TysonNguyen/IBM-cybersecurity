import { DEngineClient, Disposable, DUser, DVault, DVaultSync, DWorkspace, DWorkspaceEntry, InstallStatus, IntermediateDendronConfig, SelfContainedVault, WorkspaceSettings } from "@dendronhq/common-all";
...
export declare class WorkspaceService implements Disposable, IWorkspaceService {
    ...
    createConfig(): IntermediateDendronConfig;
