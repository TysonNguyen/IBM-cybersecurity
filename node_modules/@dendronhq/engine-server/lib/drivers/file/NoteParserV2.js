...
class NoteParserV2 {
    ...
    async parseFiles(allPaths, vault) {
        ...
        if (lodash_1.default.isUndefined(fileMetaDict[1])) {
            errors.push(common_all_1.DendronError.createFromStatus({
        ...
        return { data: noteDicts, error: new common_all_1.DendronCompositeError(errors) };
    }
    /**
     ...
     */
    file2NoteWithCache({ fpath, vault, }) {
        ...
        note = (0, common_server_1.string2Note)({ content, fname: (0, common_all_1.cleanName)(name), vault });
