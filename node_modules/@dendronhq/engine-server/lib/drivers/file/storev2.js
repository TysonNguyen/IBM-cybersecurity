...
class FileStorage {
    ...
    async initNotes() {
        ...
        this.noteFnames = new common_all_1.NoteFNamesDict(allNotes);
    ...
    async processNoteChangedByRename({ note, oldLoc, newLoc, }) {
        ...
        const _n = (0, common_server_1.file2Note)(path_1.default.join(vaultPath, note.fname + ".md"), vault);
    ...
    async renameNote(opts) {
        ...
        const noteRaw = (0, common_server_1.file2Note)(oldLocPath, oldVault);
    ...
    async writeManyNotes(notesToWrite) {
        const responses = await Promise.all(notesToWrite.map((n) => {
            this.logger.info({
                ctx: "writeManyNotes",
                msg: "writeNote:pre",
    ...
    async updateNote(note, opts) {
        ...
        if (opts === null || opts === void 0 ? void 0 : opts.newNode) {
            common_all_1.NoteUtils.addOrUpdateParentsWithDict({
                note,
    ...
    async _writeNewNote({ note, existingNote, opts, }) {
        ...
        if (existingNote) {
            ...
            common_all_1.DNodeUtils.addChild(this.notes[existingNote.parent], note);
        ...
        if (!(opts === null || opts === void 0 ? void 0 : opts.noAddParent) && !existingNote) {
            const out = common_all_1.NoteUtils.addOrUpdateParentsWithDict({
                note,
                notesDict: this.notes,
                notesByFnameDict: this.noteFnames,
                createStubs: true,
