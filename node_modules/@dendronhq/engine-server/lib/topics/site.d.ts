import { IntermediateDendronConfig, DendronSiteConfig, DuplicateNoteBehavior, DVault, HierarchyConfig, NotePropsByIdDict, NoteProps, BooleanResp, DendronPublishingConfig } from "@dendronhq/common-all";
...
export declare class SiteUtils {
    ...
    static getSitePrefixForNote(config: IntermediateDendronConfig): string;
