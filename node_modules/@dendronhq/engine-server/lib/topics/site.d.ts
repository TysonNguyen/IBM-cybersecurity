import { IntermediateDendronConfig, DendronSiteConfig, DuplicateNoteBehavior, DVault, HierarchyConfig, NotePropsDict, NoteProps, BooleanResp, DendronPublishingConfig } from "@dendronhq/common-all";
...
export declare class SiteUtils {
    ...
    static cleanNote({ note, hConfig, }: {
        ...
        created: number;
        config?: Partial<{
            global: Partial<Pick<import("@dendronhq/common-all").DendronGlobalConfig, "enablePrettyRefs" | "enableBackLinks" | "enableChildLinks">>;
        }> | undefined;
        fname: string;
    ...
    static validateConfig(sconfig: DendronSiteConfig | DendronPublishingConfig): BooleanResp;
}
