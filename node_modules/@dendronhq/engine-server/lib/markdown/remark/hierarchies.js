    ...
    function transformer(tree) {
        ...
        function addTags() {
            ...
            if (enableFrontmatterTags !== false &&
                ...
                const tagLinks = lodash_1.default.sortBy(lodash_1.default.map(tags, (tag) => (0, mdast_builder_1.listItem)((0, mdast_builder_1.paragraph)((0, utils_3.frontmatterTag2WikiLinkNoteV4)(tag, enableHashesForFMTags)))), ["custom.nav_order", "title"]);
