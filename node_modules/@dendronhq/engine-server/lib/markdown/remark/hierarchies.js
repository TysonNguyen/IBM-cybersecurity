...
function footnoteDef2html(definition) {
    ...
    if (lastChild && utils_2.RemarkUtils.isParent(lastChild)) {
...
const plugin = function (_opts) {
    ...
    let hierarchyDisplayTitle = (config === null || config === void 0 ? void 0 : config.hierarchyDisplayTitle) || "Children";
    let hierarchyDisplay = config === null || config === void 0 ? void 0 : config.hierarchyDisplay;
    ...
    function transformer(tree) {
        const root = tree;
        const { fname, vault, dest, config, insideNoteRef } = utilsv5_1.MDUtilsV5.getProcData(proc);
        ...
        function addFootnotes() {
            ...
            const footnotes = new Map(utils_2.RemarkUtils.extractFootnoteDefs(root).map((definition) => [
        ...
        const { engine } = utilsv5_1.MDUtilsV5.getProcData(proc);
        ...
        function addTags() {
            ...
            if (enableFrontmatterTags !== false &&
                ...
                const tagLinks = lodash_1.default.sortBy(lodash_1.default.map(tags, (tag) => (0, mdast_builder_1.listItem)((0, mdast_builder_1.paragraph)((0, utils_2.frontmatterTag2WikiLinkNoteV4)(tag, enableHashesForFMTags)))), ["custom.nav_order", "title"]);
