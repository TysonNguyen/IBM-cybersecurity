import { ALIAS_NAME, DendronError, DEngineClient, DLink, DNodeProps, DNoteAnchor, DNoteAnchorBasic, DNoteAnchorPositioned, DNoteLink, DNoteLoc, DNoteRefLink, DNoteRefLinkRaw, GetAnchorsResp, getSlugger, IntermediateDendronConfig, LINK_CONTENTS, LINK_NAME, NoteBlock, NoteChangeEntry, NoteProps, Position } from "@dendronhq/common-all";
...
export declare class RemarkUtils {
    ...
    static convertWikiLinkToNoteUrl(note: NoteProps, changes: NoteChangeEntry[], engine: DEngineClient, dendronConfig: IntermediateDendronConfig): (this: Processor) => (tree: Node, _vfile: VFile) => Promise<void>;
