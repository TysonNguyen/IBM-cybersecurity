...
const plugin = function () {
    ...
    function transformer(tree) {
        const root = tree;
        const { fname, vault, dest, insideNoteRef, config, engine } = utilsv5_1.MDUtilsV5.getProcData(proc);
