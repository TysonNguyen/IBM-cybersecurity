...
const decorateWikilink = async (opts) => {
    ...
    if (!wikiLink.data.anchorHeader && type !== utils_1.DECORATION_TYPES.brokenWikilink) {
        const taskDecoration = (0, taskNotes_1.decorateTaskNote)({
            range: wikilinkRange,
            fname,
            vaultName,
            engine,
