...
exports.MDUtilsV5 = exports.ProcMode = exports.ProcFlavor = void 0;
...
class MDUtilsV5 {
    ...
    static setNoteRefLvl(proc, lvl) {
        // backwards compatibility
        utils_1.MDUtilsV4.setNoteRefLvl(proc, lvl);
    ...
    static getFM(opts) {
        ...
        ws.dispose();
        const timestampConfig = wsConfig === null || wsConfig === void 0 ? void 0 : wsConfig.settings["dendron.defaultTimestampDecorationFormat"];
        const formatOption = common_all_1.DateTime[timestampConfig];
        const created = common_all_1.DateTime.fromMillis(lodash_1.default.toInteger(note.created));
        const updated = common_all_1.DateTime.fromMillis(lodash_1.default.toInteger(note.updated));
        return {
            ...custom,
            id: note.id,
            title: note.title,
    ...
    static _procRemark(opts, data) {
        ...
        let proc = (0, remark_1.default)()
            ...
            .use(wikiLinks_1.wikiLinks, data.wikiLinksOpts)
            ...
            case ProcMode.FULL:
                {
                    ...
                    if (common_all_1.ConfigUtils.getEnableMermaid(config, shouldApplyPublishRules)) {
    ...
    static _procRehype(opts, data) {
        ...
        const config = (_a = data === null || data === void 0 ? void 0 : data.engine) === null || _a === void 0 ? void 0 : _a.config;
