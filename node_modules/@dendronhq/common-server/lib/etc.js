...
exports.WebViewCommonUtils = exports.NodeJSUtils = void 0;
...
exports.NodeJSUtils = NodeJSUtils;
class WebViewCommonUtils {
}
exports.WebViewCommonUtils = WebViewCommonUtils;
/**
 *
 * @param param0
 * @returns
 */
WebViewCommonUtils.genVSCodeHTMLIndex = ({ name, jsSrc, cssSrc, url, wsRoot, browser, acquireVsCodeApi, themeMap, initialTheme, }) => {
    return `<!DOCTYPE html>
  <html lang="en">
    <head>
      <meta charset="utf-8" />
