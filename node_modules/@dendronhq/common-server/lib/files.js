...
exports.removeMDExtension = exports.resolvePath = exports.resolveTilde = exports.getAllFiles = exports.getAllFilesWithTypes = exports.globMatch = exports.deleteFile = exports.writeYAMLAsync = exports.writeYAML = exports.readYAMLAsync = exports.readYAML = exports.readMD = exports.findInParent = exports.cleanFileName = void 0;
...
async function getAllFilesWithTypes(opts) {
    ...
    try {
        const allFiles = await fs_extra_1.default.readdir(root, { withFileTypes: true });
        return {
            data: allFiles
                .map((dirent) => {
